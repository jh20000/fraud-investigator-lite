...
st.markdown(
    ...
    <div class="workflow-card">
        ...
        <div class="workflow-grid">
            ...
            <div class="step"><strong>6</strong><span class="step-body">고객 질문·조사 리포트 초안 생성</span></div>
        </div>
        <div class="workflow-note">Review 거래에 대해서만 Evidence 검색과 리포트 초안 생성을 수행합니다.</div>
    </div>
    """,
    unsafe_allow_html=True,
)
